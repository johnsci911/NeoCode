...
-- Test list_directory
print("\n=== Test: list_directory " .. config_dir .. " ===")
local res, err = hub:call_tool("filesystem", "list_directory", { path = config_dir })
if err then
...
print("\n=== Test: read_file " .. init_file .. " ===")
local res2, err2 = hub:call_tool("filesystem", "read_file", { path = init_file })
if err2 then
